...
class IntegratorFollower(Dynamics):
...
class IntegratorLeader(Dynamics):
...
def input_sys_follower(self):
    xn = self.current_state  # Markovian Systems this info sufficient
    xo = self.observed_state
    u = np.arctan2(xo[1]-xn[1], xo[0]-xn[0])
    return u

def input_sys_leader(self):
    xn = self.current_state
    xo = self.observed_state
    u = np.arctan2(xn[1]-xo[1], xn[0]-xo[0])
    return u

# Assigning input functions to each agent
a0.input_sys = input_sys_leader
a1.input_sys = input_sys_follower
a2.input_sys = input_sys_follower
a3.input_sys = input_sys_follower
a4.input_sys = input_sys_follower
#******************************************************************
#******************************************************************
#******************************************************************
